...
export class ReactNativeModal extends React.Component {
    ...
    componentDidMount() {
        ...
        let test = DeviceEventEmitter.addListener('didUpdateDimensions', this.handleDimensionsUpdate);
    ...
    componentWillUnmount() {
        ...
        DeviceEventEmitter.addListener('didUpdateDimensions', this.handleDimensionsUpdate).remove();
    }
